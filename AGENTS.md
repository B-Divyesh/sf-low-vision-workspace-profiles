# Workspace Profiles (`low-vision-workspace-profiles`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://low-vision-workspace-profiles.sociobot.in`. Artifact class: `browser-extension`.
