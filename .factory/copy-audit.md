...
- Headline: `Save readable settings for each work site` — 8 words, verb first.
- Audience and change: `For people with low vision who need larger text without losing tables and controls.` — 14 words.
- Primary action: `Try it with sample data` — 5 words.
- Outcome: `The demo opens an active sample profile.` — 7 words.
- Facts: `No account`; `Settings stored in your browser`; `Core controls cost nothing`.
...
No public copy contains: leverage, seamless, effortless, robust, powerful, intuitive, reimagine, supercharge, delightful, journey, ecosystem, or AI-powered.

## Terminology

| Concept | Word used |
|---|---|
| Address receiving settings | site |
| Saved group of settings | profile |
| Text vertical rhythm | line spacing |
| Pointer emphasis | cursor ring |
| Temporary enlarged area | hold-to-enlarge focus |
