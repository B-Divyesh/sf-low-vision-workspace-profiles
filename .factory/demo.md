...
- Actions: **Share report** passes only the fixed sample title, summary, and demo URL to the browser sharing action when that action is available. **Copy summary** writes the fixed sample summary to the clipboard.
